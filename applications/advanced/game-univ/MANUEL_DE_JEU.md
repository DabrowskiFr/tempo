...
```bash
dune exec ./applications/advanced/game-univ/src/main.exe
```

Ou via le script du jeu:

```bash
./applications/advanced/game-univ/run
```
...
- Logique jeu: `/Users/fredericdabrowski/Repos/tempo/applications/advanced/game-univ/src/game.ml`
- Types/evenements/frame: `/Users/fredericdabrowski/Repos/tempo/applications/advanced/game-univ/src/types.ml`
- Rendu et input Raylib: `/Users/fredericdabrowski/Repos/tempo/applications/advanced/game-univ/src/engine/raylib_adapter.ml`
