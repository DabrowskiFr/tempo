...
let default_system_file = "applications/advanced/refactor/spec/system.concerto"
let default_reconfig_file = "applications/advanced/refactor/spec/reconfig.concerto"
...
let parse_args () =
  ...
  let trace_dir = ref "applications/advanced/refactor/traces" in
